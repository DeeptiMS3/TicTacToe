...
function myfunc() {
    ...
    let score1 = parseInt(localStorage.getItem('ScoreOne')) || 0;
    let score2 = parseInt(localStorage.getItem('ScoreTwo')) || 0;
    ...
    // Here, Checking about Tie 
        ...
        if (flag == 1) {
            document.getElementById('print')
                .innerHTML = `${playerOne}'s Turn`;
        }
        else {
            document.getElementById('print')
                .innerHTML = `${playerTwo}'s Turn`;
        }
    }
}
